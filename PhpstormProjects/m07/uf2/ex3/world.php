...
$consulta = "select sum(Population) poblacion from country where continent='".$continent."';";
...
<table>
    ...
    <thead><td colspan="4" align="center" bgcolor="cyan">Poblacion de <?php echo $continent;?></td></thead>
    <?php
    # (3.2) Bucle while
